...
public class SEBDivActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sebdiv);
    ...
    public void addRecordtoDB(View view)
    {
        ...
        String method = "insertsebStudent";
        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        // http://localhost/webapp/insertbeaStudent.php?rno=1&fname=sai&mname=ravi&lname=patil&email=saipatil@gmail.com
        String url = "http://192.168.43.63/webapp/insertsebStudent.php?rollno="+rollno+"&fname="+fname+"&mname="+mname+"&lname="+lname+"&emailid="+emailid;
