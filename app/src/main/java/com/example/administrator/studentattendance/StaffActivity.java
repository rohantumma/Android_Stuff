...
public class StaffActivity extends AppCompatActivity {
    ...
    EditText et_fname,et_mname,et_lname,et_emailid;
    String fname,mname,lname,emailid;
    ...
    public void addRecordtoDB(View view)
    {
        ...
        String method = "insertstaff";
        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        // http://localhost/webapp/insertbeaStudent.php?rno=1&fname=sai&mname=ravi&lname=patil&email=saipatil@gmail.com
        String url = "http://192.168.43.63/webapp/insertstaff.php?fname="+fname+"&mname="+mname+"&lname="+lname+"&emailid="+emailid;
